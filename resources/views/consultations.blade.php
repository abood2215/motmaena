    ...
    <div style="max-width:1000px;margin:0 auto;">
      ...
      <div class="pain-grid">
        ...
        <div class="pain-card reveal reveal-delay-1">
          <div class="emoji">📚</div>
          <p><strong>{{ app()->getLocale() === 'ar' ? 'قلق على مستقبل طفلك' : 'Anxiety about your child\'s future' }}</strong>
    ...
    <div style="max-width:720px;margin:0 auto;">
      ...
      <div class="faq-list reveal">
        ...
        $faqs = app()->getLocale() === 'ar' ? [
          ['q' => 'ما الفرق بين الاستشارة هنا وعند أي مستشار آخر؟', 'a' => 'المتخصصون في مركز مطمئنة يجمعون بين الخبرة الأكاديمية والتطبيق الميداني. الجلسة مبنية على فهم وضعك تحديداً — ليست نصائح عامة بل خطة عمل مخصصة لك أنت.'],
          ...
          ['q' => 'كيف يتم اختيار المتخصص المناسب لي؟', 'a' => 'عند التواصل عبر واتساب سيسألك الفريق بعض الأسئلة البسيطة ثم يرشدك إلى المتخصص الأنسب لطبيعة استشارتك سواء كانت أسرية أو تربوية أو اجتماعية.'],
