...
function sendTpl(n) {
  ...
  const t = mType;
  const s = '★';  // U+2605 — confirmed working
  const c = '◆';  // U+25C6 — confirmed working
  const h = '♦';  // U+2666 — text symbol, not emoji
  const sep = '▬▬▬▬▬▬▬▬▬▬▬▬▬';
  const msgs = {
    ...
    4: s + ' *السلام عليكم*\n' + sep + '\n\nشكرًا على تواصلك مع مركز مطمئنة\n\n' + c + ' يسعدنا نجاوب على أي استفسار عندك بخصوص *' + t + '*\n\nلا تتردد، احنا هنا دائمًا لأجلك ' + h,
    5: s + ' *السلام عليكم*\nمن فريق مركز مطمئنة\n' + sep + '\n\n' + c + ' يسعدنا إن جلستك اكتملت بنجاح\n\nرأيك يهمّنا كثيرًا ' + h + '\nهل تقدر تشاركنا انطباعك عن تجربتك معنا؟\n\n_نسعد دائمًا بخدمتك_',
  };
