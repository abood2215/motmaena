...
<div class="modal-overlay" id="modal-overlay" onclick="closeModalOnBg(event)">
  <div class="modal" id="modal">
    ...
    <div class="modal-wa-section">
      ...
      <button class="wa-template" id="tpl-1" onclick="sendTemplate(1)">
        🌿 مرحباً، معي فريق مطمئنة — بخصوص طلب الاستشارة، هل يناسبك نحدد موعداً؟
      </button>
      <button class="wa-template" id="tpl-2" onclick="sendTemplate(2)">
        ✅ تم تأكيد حجزك — سنتواصل معك قريباً لتحديد موعد الاستشارة.
      </button>
      <button class="wa-template" id="tpl-3" onclick="sendTemplate(3)">
        🔔 تذكير: موعدك مع مركز مطمئنة قريب، لا تنسَ التواصل معنا.
      </button>
    </div>
  </div>
</div>
...
function sendTemplate(n) {
  ...
  const msgs = {
    1: `مرحباً،\nمعي فريق مركز مطمئنة 🌿\nتواصلنا معك بخصوص طلب الاستشارة (${currentType}).\nهل يناسبك نحدد موعداً الآن؟`,
    2: `مرحباً،\n✅ تم تأكيد طلبك في مركز مطمئنة.\nنوع الاستشارة: ${currentType}\nسنتواصل معك قريباً لتحديد موعد مناسب.\nشكراً لثقتك بنا 🌿`,
    3: `مرحباً،\n🔔 تذكير من مركز مطمئنة\nطلبك لاستشارة (${currentType}) لا يزال قيد المتابعة.\nنرجو التواصل معنا لتحديد الموعد المناسب لك.`,
  };
