...
function quickWA(phone, type) {
  const msg = 'السلام عليكم\nمعاك فريق مركز مطمئنة\nتواصلنا معك بخصوص طلب الاستشارة (' + type + ')\nهل يناسبك نحدد موعدًا؟';
...
function sendTpl(n) {
  ...
  const t = mType;
  const msgs = {
    1: 'السلام عليكم\n\nمعاك فريق مركز مطمئنة للصحة النفسية والتنمية الذاتية\n\nوصلنا طلبك للاستشارة بخصوص *' + t + '* وشكرًا على ثقتك فينا\n\nودّنا نحجزلك موعد مع المختص المناسب\nهل تقدر تعطينا وقتك المناسب؟',
    2: 'السلام عليكم\n\nتم تأكيد موعدك في مركز مطمئنة\nنوع الاستشارة: *' + t + '*\n\nسيتواصل معك المختص في الوقت المحدد\nنتمنى لك جلسة مثمرة، مركز مطمئنة',
    3: 'السلام عليكم\n\nمعاك فريق مركز مطمئنة\nلاحظنا إنك ما رديت على رسالتنا السابقة، بدّنا نتأكد إنك بخير\n\nطلبك لاستشارة *' + t + '* لا يزال محجوزًا ومتاحًا لك\nمتى يناسبك نتواصل؟',
    4: 'السلام عليكم\n\nشكرًا على تواصلك مع مركز مطمئنة\nنقدر نجاوب على أي استفسار عندك بخصوص *' + t + '*\nلا تتردد، احنا هنا لأجلك',
    5: 'السلام عليكم\n\nمن فريق مركز مطمئنة، يسعدنا إن جلستك اكتملت بنجاح\n\nرأيك يهمّنا كثيرًا، هل تقدر تشاركنا انطباعك عن تجربتك معنا؟\nوإذا احتجت أي شيء في أي وقت، احنا دايمًا هنا'
  };
